...
introduced in Ruby 2.6 (and also Beginless Range in Ruby 2.7) is conceptionally not straightforward.
...
or more accurately *positive endlessness*.  For this reason, the use of
...
can specify their own infinities in initialization of {Rangeary} with options of
...
* {Rangeary#last_element} includes a monkey patch (which used to raise
  ...
  {https://bugs.ruby-lang.org/issues/18994} for detail of the bug,
  which was very shortly resolved with ({patch #6324}[https://github.com/ruby/ruby/pull/6324],
